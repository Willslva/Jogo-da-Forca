# Generated by Django 2.0.7 on 2018-08-24 00:52
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='partida',
            name='usuario',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='forca.UUIDUser', verbose_name='Usuário'),
        ),
        migrations.AddField(
            model_name='partida',
            name='word',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='forca.Palavra', verbose_name='Palavra'),
        ),
        migrations.AddField(
            model_name='palavra',
            name='id_user',
